 ...
 *
 * Used by the fetch CLIs in source.ts (dep tarballs) and webkit.ts (prebuilt
 * tarballs). Extracted because the retry + temp-then-rename logic was
 * copy-pasted and the platform-specific

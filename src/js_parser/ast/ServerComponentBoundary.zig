...
pub const List = struct {
    ...
    pub const Slice = struct {
        ...
        pub fn bitSet(scbs: Slice, alloc: std.mem.Allocator, input_file_count: usize) !std.bit_set.Dynamic {
            var scb_bitset = try std.bit_set.Dynamic.initEmpty(alloc, input_file_count);

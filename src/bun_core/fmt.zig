...
pub const JavaScriptSyntaxHighlighter = @import("JavaScriptSyntaxHighlighter.zig");

pub fn fmtJavaScript(text: []const u8, opts: JavaScriptSyntaxHighlighter.Options) JavaScriptSyntaxHighlighter {

...
const ARCHIVE_FORMAT_BASE_MASK = __helpers.promoteIntLiteral(c_int, 0xff0000, .hex);
const ARCHIVE_FORMAT_CPIO = __helpers.promoteIntLiteral(c_int, 0x10000, .hex);
...
const ARCHIVE_FORMAT_SHAR = __helpers.promoteIntLiteral(c_int, 0x20000, .hex);
...
const ARCHIVE_FORMAT_TAR = __helpers.promoteIntLiteral(c_int, 0x30000, .hex);
...
const ARCHIVE_FORMAT_ISO9660 = __helpers.promoteIntLiteral(c_int, 0x40000, .hex);
const ARCHIVE_FORMAT_ISO9660_ROCKRIDGE = ARCHIVE_FORMAT_ISO9660 | @as(c_int, 1);
const ARCHIVE_FORMAT_ZIP = __helpers.promoteIntLiteral(c_int, 0x50000, .hex);
const ARCHIVE_FORMAT_EMPTY = __helpers.promoteIntLiteral(c_int, 0x60000, .hex);
const ARCHIVE_FORMAT_AR = __helpers.promoteIntLiteral(c_int, 0x70000, .hex);
const ARCHIVE_FORMAT_AR_GNU = ARCHIVE_FORMAT_AR | @as(c_int, 1);
const ARCHIVE_FORMAT_AR_BSD = ARCHIVE_FORMAT_AR | @as(c_int, 2);
const ARCHIVE_FORMAT_MTREE = __helpers.promoteIntLiteral(c_int, 0x80000, .hex);
const ARCHIVE_FORMAT_RAW = __helpers.promoteIntLiteral(c_int, 0x90000, .hex);
const ARCHIVE_FORMAT_XAR = __helpers.promoteIntLiteral(c_int, 0xA0000, .hex);
const ARCHIVE_FORMAT_LHA = __helpers.promoteIntLiteral(c_int, 0xB0000, .hex);
const ARCHIVE_FORMAT_CAB = __helpers.promoteIntLiteral(c_int, 0xC0000, .hex);
const ARCHIVE_FORMAT_RAR = __helpers.promoteIntLiteral(c_int, 0xD0000, .hex);
const ARCHIVE_FORMAT_7ZIP = __helpers.promoteIntLiteral(c_int, 0xE0000, .hex);
const ARCHIVE_FORMAT_WARC = __helpers.promoteIntLiteral(c_int, 0xF0000, .hex);
const ARCHIVE_FORMAT_RAR_V5 = __helpers.promoteIntLiteral(c_int, 0x100000, .hex);
...
const ARCHIVE_EXTRACT_HFS_COMPRESSION_FORCED = __helpers.promoteIntLiteral(c_int, 0x8000, .hex);
const ARCHIVE_EXTRACT_SECURE_NOABSOLUTEPATHS = __helpers.promoteIntLiteral(c_int, 0x10000, .hex);
const ARCHIVE_EXTRACT_CLEAR_NOCHANGE_FFLAGS = __helpers.promoteIntLiteral(c_int, 0x20000, .hex);
const ARCHIVE_EXTRACT_SAFE_WRITES = __helpers.promoteIntLiteral(c_int, 0x40000, .hex);

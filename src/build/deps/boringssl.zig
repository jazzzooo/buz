//! boringssl compile recipe. Hand-maintained; update when bumping the dep.
...
pub const dep: m.Dep = .{
    ...
    .groups = &.{
        .{
            .cxx = true,
            .flags = &.{ "-fno-c++-static-destructors", "-DBORINGSSL_IMPLEMENTATION", "-std=c++17", "-fno-exceptions", "-fno-rtti", "-fno-strict-aliasing", "-fno-common", "-fvisibility=hidden", "-Wa,--noexecstack" },
            .includes = &.{.{ .dep = .{ "boringssl", "include" } }},
            .files = &.{
                "crypto/aes/aes.cc",

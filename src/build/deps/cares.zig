//! cares compile recipe. Hand-maintained; update when bumping the dep.
...
pub const dep: m.Dep = .{
    ...
    .groups = &.{
        .{
            .flags = &.{ "-fPIC", "-DHAVE_CONFIG_H=1", "-DCARES_BUILDING_LIBRARY", "-D_GNU_SOURCE", "-D_POSIX_C_SOURCE=200809", "-D_XOPEN_SOURCE=700" },
            .includes = &.{ .{ .dep = .{ "cares", "include" } }, .{ .dep = .{ "cares", "src/lib" } }, .{ .dep = .{ "cares", "src/lib/include" } }, .{ .gen = .{ "cares", "" } } },
            .files = &.{

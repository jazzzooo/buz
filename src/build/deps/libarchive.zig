//! libarchive compile recipe. Hand-maintained; update when bumping the dep.
...
pub const dep: m.Dep = .{
    ...
    .groups = &.{
        .{
            .flags = &.{ "-fPIC", "-DHAVE_CONFIG_H=1", "-DLIBARCHIVE_STATIC=1", "-D__LIBARCHIVE_ENABLE_VISIBILITY", "-fvisibility=hidden", "-Wno-incompatible-pointer-types-discards-qualifiers" },
            .includes = &.{ .{ .dep = .{ "libarchive", "libarchive" } }, .{ .gen = .{ "zlib", "" } }, .{ .gen = .{ "libarchive", "" } } },
            .files = &.{

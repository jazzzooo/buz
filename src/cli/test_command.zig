...
pub const JunitReporter = struct {
    ...
    pub fn endTestSuite(this: *JunitReporter) bun.OOM!void {
        ...
        var arena = std.heap.ArenaAllocator.init(bun.default_allocator);
        defer arena.deinit();
        var stack_fallback_allocator_buffer: [4096]u8 = undefined;
...
pub const TestCommand = struct {
    ...
    pub fn exec(ctx: Command.Context) !void {
        ...
        var inline_snapshots_to_write = std.array_hash_map.Auto(TestRunner.File.ID, std.array_list.Managed(Snapshots.InlineSnapshotToWrite)).empty;

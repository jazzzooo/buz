...
pub const __ENVIRONMENT_MAC_OS_X_VERSION_MIN_REQUIRED__ = __helpers.promoteIntLiteral(c_int, 120400, .decimal);
...
pub const MAX_INT32 = __helpers.promoteIntLiteral(c_int, 2147483648, .decimal);
pub const MAX_INT52 = __helpers.promoteIntLiteral(c_int, 9007199254740991, .decimal);
pub const NumberTag = __helpers.promoteIntLiteral(c_longlong, 0xfffe000000000000, .hex);

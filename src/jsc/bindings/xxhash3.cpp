// Runtime-dispatched SIMD xxHash3 (XXH3_64bits) via Google Highway. A single
// binary selects the widest ISA the CPU supports.
//
...
//
// Reference constants: vendor/zstd/lib/common/xxhash.h.

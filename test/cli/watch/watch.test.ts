...
import { bunEnv, bunExe, isBroken, isDebug, isWindows, tmpdirSync } from "harness";
import { rmSync } from "node:fs";
import { join } from "node:path";

const internalForTesting = isDebug ? await import("bun:internal-for-testing") : undefined;
...
it.skipIf(!isDebug)("propagates unavailable FileWatcher concurrency", () => {
  expect(internalForTesting!.fileWatcherStartWithUnavailableIo()).toBe("ConcurrencyUnavailable");
});
